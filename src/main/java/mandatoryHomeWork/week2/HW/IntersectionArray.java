...
public class IntersectionArray 
{
	//Input: two int []
		...
		@Test
		public void tst1() {
			Assert.assertEquals(new int[] {2}, arrayIntersect(new int[] {1,2,2,1},new int[] {2,2}));
		}

		@Test
		public void tst2() {
			Assert.assertEquals(new int[] {4,9}, arrayIntersect(new int[] {4,9,5},new int[] {9,4,9,8,4}));
		}
}
